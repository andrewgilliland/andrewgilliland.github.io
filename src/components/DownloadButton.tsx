...
const DownloadButton = ({ className }: DownloadButtonProps) => {
  return (
    ...
    >
      ...
      <div className="text-white min-w-max md:text-2xl bg-black border-2 border-white rounded px-12 md:px-24 py-4 transform-gpu transition group-hover:-translate-x-2 group-hover:-translate-y-2 group-active:translate-x-0 group-active:translate-y-0">
        Download
      </div>
    </button>
  );
