  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <rect x="60" y="60" width="10" height="10" fill="#EA580C" />
        <rect x="70" y="60" width="10" height="10" fill="#EA580C" />
        <rect x="80" y="60" width="10" height="10" fill="#EA580C" />
        <rect x="50" y="60" width="10" height="10" fill="#EA580C" />
        <rect x="40" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="30" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="40" y="90" width="10" height="10" fill="#EA580C" />
        <rect x="60" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="80" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="50" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="60" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="70" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="90" y="70" width="10" height="10" fill="#EA580C" />
        <rect x="70" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="80" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="90" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="100" y="80" width="10" height="10" fill="#EA580C" />
        <rect x="110" y="90" width="10" height="10" fill="#EA580C" />
        <rect x="10" y="140" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="150" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="160" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="170" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="180" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="190" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="200" width="10" height="10" fill="#DC2626" />
        <rect x="10" y="210" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="30" y="210" width="10" height="10" fill="#DC2626" />
        <rect x="20" y="150" width="10" height="10" fill="#DC2626" />
        <rect x="20" y="160" width="10" height="10" fill="#DC2626" />
        <rect x="20" y="180" width="10" height="10" fill="#DC2626" />
        <rect x="30" y="180" width="10" height="10" fill="#DC2626" />
        <rect x="20" y="190" width="10" height="10" fill="#DC2626" />
        <rect x="30" y="240" width="10" height="10" fill="#DC2626" />
        <rect x="40" y="240" width="10" height="10" fill="#DC2626" />
        <rect x="50" y="240" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="60" y="230" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="100" y="160" width="10" height="10" fill="#DC2626" />
        <rect x="100" y="170" width="10" height="10" fill="#DC2626" />
        <rect x="100" y="180" width="10" height="10" fill="#DC2626" />
        <rect x="100" y="190" width="10" height="10" fill="#DC2626" />
        <rect x="100" y="200" width="10" height="10" fill="#DC2626" />
        <rect x="100" y="210" width="10" height="10" fill="#DC2626" />
        <rect x="110" y="220" width="10" height="10" fill="#DC2626" />
        <rect x="120" y="230" width="10" height="10" fill="#DC2626" />
        <rect x="130" y="240" width="10" height="10" fill="#DC2626" />
        <rect x="140" y="240" width="10" height="10" fill="#DC2626" />
        <rect x="150" y="240" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="110" y="200" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="120" y="200" width="10" height="10" fill="#DC2626" />
        <rect x="30" y="150" width="10" height="10" fill="#DC2626" />
        ...
        <rect x="70" y="130" width="10" height="10" fill="#FED7AA" />
        <rect x="50" y="80" width="10" height="10" fill="#FED7AA" />
        <rect x="50" y="100" width="10" height="10" fill="#FED7AA" />
        <rect x="50" y="120" width="10" height="10" fill="#FED7AA" />
        ...
        <rect x="60" y="130" width="10" height="10" fill="#FED7AA" />
        ...
        <rect x="110" y="100" width="10" height="10" fill="#FED7AA" />
        <rect x="110" y="110" width="10" height="10" fill="#FED7AA" />
        <rect x="100" y="110" width="10" height="10" fill="#FED7AA" />
        <rect x="90" y="120" width="10" height="10" fill="#FED7AA" />
        <rect x="90" y="130" width="10" height="10" fill="#FED7AA" />
        <rect x="100" y="120" width="10" height="10" fill="#FED7AA" />
