...
const RedMage: FC<RedMageProps> = ({ className }) => {
  const color = colors.red[600];
  ...
  return (
    ...
    >
      <g clip-path="url(#clip0_48_3)">
        ...
        <rect x="70" y="20" width="10" height="10" fill={color} />
        <rect x="80" y="20" width="10" height="10" fill={color} />
        <rect x="90" y="20" width="10" height="10" fill={color} />
        <rect x="100" y="10" width="10" height="10" fill={color} />
        <rect x="50" y="20" width="10" height="10" fill={color} />
        <rect x="60" y="20" width="10" height="10" fill={color} />
        <rect x="70" y="10" width="10" height="10" fill={color} />
        <rect x="80" y="10" width="10" height="10" fill={color} />
        <rect x="90" y="10" width="10" height="10" fill={color} />
        <rect x="50" y="30" width="10" height="10" fill={color} />
        <rect x="60" y="30" width="10" height="10" fill={color} />
        <rect x="70" y="30" width="10" height="10" fill={color} />
        <rect x="80" y="30" width="10" height="10" fill={color} />
        <rect x="90" y="30" width="10" height="10" fill={color} />
        <rect x="100" y="20" width="10" height="10" fill={color} />
        <rect x="100" y="50" width="10" height="10" fill={color} />
        <rect x="110" y="50" width="10" height="10" fill={color} />
        <rect x="120" y="50" width="10" height="10" fill={color} />
        <rect x="130" y="50" width="10" height="10" fill={color} />
        <rect x="140" y="50" width="10" height="10" fill={color} />
        <rect x="150" y="50" width="10" height="10" fill={color} />
        <rect x="150" y="40" width="10" height="10" fill={color} />
        <rect x="160" y="40" width="10" height="10" fill={color} />
        <rect x="50" y="50" width="10" height="10" fill={color} />
        <rect x="50" y="40" width="10" height="10" fill={color} />
        <rect x="60" y="40" width="10" height="10" fill={color} />
        <rect x="70" y="40" width="10" height="10" fill={color} />
        <rect x="80" y="40" width="10" height="10" fill={color} />
        <rect x="90" y="40" width="10" height="10" fill={color} />
        <rect x="120" y="40" width="10" height="10" fill={color} />
        <rect x="60" y="50" width="10" height="10" fill={color} />
        <rect x="70" y="50" width="10" height="10" fill={color} />
        <rect x="80" y="50" width="10" height="10" fill={color} />
        <rect x="40" y="60" width="10" height="10" fill={color} />
        <rect x="50" y="60" width="10" height="10" fill={color} />
        <rect x="60" y="60" width="10" height="10" fill={color} />
        <rect x="70" y="60" width="10" height="10" fill={color} />
        <rect x="80" y="60" width="10" height="10" fill={color} />
        <rect x="90" y="60" width="10" height="10" fill={color} />
        <rect x="100" y="60" width="10" height="10" fill={color} />
        <rect x="110" y="60" width="10" height="10" fill={color} />
        <rect x="120" y="60" width="10" height="10" fill={color} />
        <rect x="130" y="60" width="10" height="10" fill={color} />
        <rect x="140" y="60" width="10" height="10" fill={color} />
        <rect x="100" y="70" width="10" height="10" fill={color} />
        <rect x="90" y="70" width="10" height="10" fill={color} />
        <rect x="70" y="70" width="10" height="10" fill={color} />
        <rect x="50" y="70" width="10" height="10" fill={color} />
        <rect x="30" y="70" width="10" height="10" fill={color} />
        <rect x="60" y="70" width="10" height="10" fill={color} />
        <rect x="40" y="70" width="10" height="10" fill={color} />
        <rect x="60" y="80" width="10" height="10" fill={color} />
        <rect x="50" y="80" width="10" height="10" fill={color} />
        <rect x="40" y="80" width="10" height="10" fill={color} />
        <rect x="30" y="80" width="10" height="10" fill={color} />
        <rect x="20" y="80" width="10" height="10" fill={color} />
        <rect x="10" y="80" width="10" height="10" fill={color} />
        <rect x="80" y="70" width="10" height="10" fill={color} />
        <rect x="110" y="70" width="10" height="10" fill={color} />
        <rect x="80" y="120" width="10" height="10" fill={color} />
        <rect x="70" y="120" width="10" height="10" fill={color} />
        <rect x="80" y="130" width="10" height="10" fill={color} />
        <rect x="70" y="130" width="10" height="10" fill={color} />
        <rect x="60" y="130" width="10" height="10" fill={color} />
        <rect x="60" y="120" width="10" height="10" fill={color} />
        <rect x="50" y="120" width="10" height="10" fill={color} />
        <rect x="30" y="120" width="10" height="10" fill={color} />
        <rect x="20" y="120" width="10" height="10" fill={color} />
        <rect x="30" y="110" width="10" height="10" fill={color} />
        <rect x="10" y="130" width="10" height="10" fill={color} />
        <rect x="40" y="130" width="10" height="10" fill={color} />
        <rect x="90" y="140" width="10" height="10" fill={color} />
        <rect x="100" y="140" width="10" height="10" fill={color} />
        <rect x="110" y="140" width="10" height="10" fill={color} />
        <rect x="120" y="140" width="10" height="10" fill={color} />
        <rect x="130" y="140" width="10" height="10" fill={color} />
        <rect x="140" y="140" width="10" height="10" fill={color} />
        <rect x="150" y="140" width="10" height="10" fill={color} />
        <rect x="150" y="130" width="10" height="10" fill={color} />
        <rect x="140" y="130" width="10" height="10" fill={color} />
        <rect x="140" y="120" width="10" height="10" fill={color} />
        <rect x="120" y="130" width="10" height="10" fill={color} />
        <rect x="110" y="130" width="10" height="10" fill={color} />
        <rect x="100" y="130" width="10" height="10" fill={color} />
        <rect x="100" y="120" width="10" height="10" fill={color} />
        <rect x="110" y="120" width="10" height="10" fill={color} />
        <rect x="120" y="120" width="10" height="10" fill={color} />
        <rect x="110" y="110" width="10" height="10" fill={color} />
        <rect x="110" y="150" width="10" height="10" fill={color} />
        <rect x="120" y="150" width="10" height="10" fill={color} />
        <rect x="130" y="150" width="10" height="10" fill={color} />
        <rect x="140" y="150" width="10" height="10" fill={color} />
        <rect x="150" y="150" width="10" height="10" fill={color} />
        <rect x="120" y="160" width="10" height="10" fill={color} />
        <rect x="130" y="160" width="10" height="10" fill={color} />
        <rect x="140" y="160" width="10" height="10" fill={color} />
        <rect x="150" y="160" width="10" height="10" fill={color} />
        <rect x="160" y="160" width="10" height="10" fill={color} />
        <rect x="130" y="170" width="10" height="10" fill={color} />
        <rect x="140" y="170" width="10" height="10" fill={color} />
        <rect x="150" y="170" width="10" height="10" fill={color} />
        <rect x="160" y="170" width="10" height="10" fill={color} />
        <rect x="140" y="180" width="10" height="10" fill={color} />
        <rect x="150" y="180" width="10" height="10" fill={color} />
        <rect x="160" y="180" width="10" height="10" fill={color} />
        <rect x="150" y="190" width="10" height="10" fill={color} />
        <rect x="160" y="190" width="10" height="10" fill={color} />
        <rect x="150" y="200" width="10" height="10" fill={color} />
        <rect x="160" y="200" width="10" height="10" fill={color} />
        <rect x="160" y="210" width="10" height="10" fill={color} />
        <rect x="160" y="220" width="10" height="10" fill={color} />
        <rect x="160" y="230" width="10" height="10" fill={color} />
        <rect x="160" y="240" width="10" height="10" fill={color} />
        <rect x="130" y="220" width="10" height="10" fill={color} />
        <rect x="140" y="220" width="10" height="10" fill={color} />
        <rect x="150" y="220" width="10" height="10" fill={color} />
        <rect x="130" y="230" width="10" height="10" fill={color} />
        <rect x="140" y="230" width="10" height="10" fill={color} />
        <rect x="150" y="230" width="10" height="10" fill={color} />
        <rect x="50" y="230" width="10" height="10" fill={color} />
        <rect x="40" y="230" width="10" height="10" fill={color} />
        <rect x="30" y="230" width="10" height="10" fill={color} />
        <rect x="20" y="230" width="10" height="10" fill={color} />
        <rect x="20" y="220" width="10" height="10" fill={color} />
        <rect x="20" y="210" width="10" height="10" fill={color} />
        <rect x="20" y="200" width="10" height="10" fill={color} />
        <rect x="20" y="190" width="10" height="10" fill={color} />
        <rect x="20" y="180" width="10" height="10" fill={color} />
        <rect x="110" y="240" width="10" height="10" fill={color} />
        <rect x="100" y="240" width="10" height="10" fill={color} />
        <rect x="90" y="240" width="10" height="10" fill={color} />
        <rect x="80" y="240" width="10" height="10" fill={color} />
        <rect x="70" y="240" width="10" height="10" fill={color} />
        <rect x="60" y="240" width="10" height="10" fill={color} />
        <rect x="70" y="230" width="10" height="10" fill={color} />
        <rect x="80" y="220" width="10" height="10" fill={color} />
        <rect x="90" y="210" width="10" height="10" fill={color} />
        <rect x="100" y="210" width="10" height="10" fill={color} />
        <rect x="110" y="210" width="10" height="10" fill={color} />
        <rect x="90" y="220" width="10" height="10" fill={color} />
        <rect x="80" y="230" width="10" height="10" fill={color} />
        <rect x="90" y="230" width="10" height="10" fill={color} />
        <rect x="100" y="230" width="10" height="10" fill={color} />
        <rect x="110" y="230" width="10" height="10" fill={color} />
        <rect x="100" y="220" width="10" height="10" fill={color} />
        <rect x="110" y="220" width="10" height="10" fill={color} />
        <rect x="70" y="220" width="10" height="10" fill={color} />
        <rect x="70" y="210" width="10" height="10" fill={color} />
        <rect x="80" y="210" width="10" height="10" fill={color} />
        <rect x="50" y="150" width="10" height="10" fill={color} />
        <rect x="50" y="160" width="10" height="10" fill={color} />
        <rect x="50" y="170" width="10" height="10" fill={color} />
        <rect x="60" y="160" width="10" height="10" fill={color} />
        <rect x="60" y="170" width="10" height="10" fill={color} />
        <rect x="60" y="180" width="10" height="10" fill={color} />
        <rect x="60" y="190" width="10" height="10" fill={color} />
        <rect x="70" y="190" width="10" height="10" fill={color} />
        <rect x="80" y="190" width="10" height="10" fill={color} />
        <rect x="90" y="190" width="10" height="10" fill={color} />
        <rect x="100" y="190" width="10" height="10" fill={color} />
        <rect x="110" y="190" width="10" height="10" fill={color} />
        <rect x="110" y="180" width="10" height="10" fill={color} />
        <rect x="110" y="170" width="10" height="10" fill={color} />
        <rect x="120" y="180" width="10" height="10" fill={color} />
        <rect x="60" y="150" width="10" height="10" fill={color} />
