...
const NotePage: FC<NotePageProps> = async ({ pagePath }) => {
  ...
  return (
    <div className="px-[10%] md:p-0 md:w-[40em] mx-auto mt-12 min-h-screen">
      ...
      <div
        className="prose prose-h2:text-yellow-300 prose-h3:text-purple-400 prose-h4:text-pink-400 prose-h5:text-gray-500 prose-p:text-gray-200 prose-ul:text-gray-200 prose-ol:text-gray-200 prose-pre:border-2 prose-pre:border-gray-400 prose-code:bg-gray-800 prose-code:text-white prose-code:before:content-none prose-code:after:content-none prose-a:text-cyan-300 prose-a:no-underline prose-a:font-semibold prose-strong:font-semibold prose-strong:text-emerald-400 my-20 max-w-2xl"
